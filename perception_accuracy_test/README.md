# perception_accuracy_test

This simple IoT device allows a user to test their perception and estimation skills (i.e. eyeballing) via a series of small games.

For more information, check out the [project details on Hackster.io](https://www.hackster.io/marloncmcpherson/iot-perception-accuracy-test-8b02b1).
